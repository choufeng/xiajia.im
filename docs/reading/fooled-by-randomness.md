...
<div class="retrieval-quiz">
  <div class="quiz-card">
    <div class="quiz-q"><span class="quiz-num">Q1</span>塔勒布用「一千个俄罗斯轮盘赌玩家」打比方：为什么把赢家单独拎出来分析「他做了什么导致赢」，在根本上是搞错了问题？</div>
    <details class="quiz-a"><summary>想好了，看答案</summary>
      <p>已发生的事件（现实）只是无数<strong>可能世界</strong>中的一个样本。我们看不见那些扣下扳机死掉的人——他们没法接受采访。</p>
      <p>正确的问题不是「他做了什么导致赢」，而是「在一千个做同样事的人里，有多少个活下来」——要看<strong>可能结果的分布</strong>，不是单个赢家。</p>
    </details>
  </div>
  <div class="quiz-card">
    <div class="quiz-q"><span class="quiz-num">Q2</span>书店里全是成功企业家的传记，为什么这些「成功方法论」天然不可全信？背后的机制是什么？</div>
    <details class="quiz-a"><summary>想好了，看答案</summary>
      <p>赢家被看见，输家被埋葬 → 样本严重偏斜。所有从赢家身上总结出的方法论，都犯了<strong>幸存者偏差</strong>。</p>
      <p>读任何成功案例，先问：<strong>做同样事却失败的样本在哪？他们身上是不是也有同样的特征？</strong></p>
    </details>
  </div>
  <div class="quiz-card">
    <div class="quiz-q"><span class="quiz-num">Q3</span>一个年化 15% 的基金经理，为什么你越频繁地盯他、看到的「坏消息」反而越多？这些坏消息和最终收益是什么关系？</div>
    <details class="quiz-a"><summary>想好了，看答案</summary>
      <p>任意一小时内他约 50% 概率在亏钱。盯得越频繁，看到的「坏消息」越多，但这些都只是<strong>噪音</strong>——和最终年化收益几乎无关。</p>
      <p>处方：把<strong>信息摄入频率降到和决策频率匹配</strong>。一年调一次仓，不该每天看行情；一季度的判断，不该被一分钟波动绑架。</p>
    </details>
  </div>
  <div class="quiz-card">
    <div class="quiz-q"><span class="quiz-num">Q4</span>一个 90% 概率赚 100 万、10% 概率亏 2000 万的策略，单次大概率赢钱——为什么塔勒布说长期跑必死？真正的判断标准是什么？</div>
    <details class="quiz-a"><summary>想好了，看答案</summary>
      <p>判断标准是<strong>期望值 = Σ（每种结果的值 × 该结果的概率）</strong>，不是「这次能不能成」。单次大概率赢 ≠ 长期赢。</p>
      <p>一次漂亮的押注配上致命的<strong>尾部风险</strong>＝慢性自杀。任何结果都要放进<strong>可能结果分布</strong>里看潜在下行和基础概率，而非单点。</p>
    </details>
  </div>
  <div class="quiz-card">
    <div class="quiz-q"><span class="quiz-num">Q5</span>事情发生之后，为什么我们总觉得「早就该看出来」（后见之明）？用这种心态评判事前决策为什么对所有当事人都不公平？怎么对抗？</div>
    <details class="quiz-a"><summary>想好了，看答案</summary>
      <p>历史在回望时总是确定的，在经历时永远混沌。用「事后的确定性」去评判「事前的决策」对当事人不公平——这是<strong>后见之明偏误</strong>。</p>
      <p>对抗办法：写<strong>决策日志</strong>，决策当下写下「看到了什么、押什么、预期概率分布」，事后再诚实核对「我当时到底判断对了没有」。</p>
    </details>
  </div>
  <div class="quiz-card">
    <div class="quiz-q"><span class="quiz-num">Q6</span>脆弱、坚固、反脆弱三者的本质差别是什么？为什么塔勒布说「追求零故障的系统最脆弱」？</div>
    <details class="quiz-a"><summary>想好了，看答案</summary>
      <p>脆弱＝怕波动（玻璃杯）；坚固＝不怕波动但不受益（石头）；<strong>反脆弱＝从波动中变得更强</strong>（肌肉、免疫系统）。</p>
      <p>追求「零故障」的系统最脆弱，因为它<strong>没练过应对故障</strong>。目标不是躲开随机性，而是设计能从意外中受益的结构（现金冗余、可逆决策、不押单一方向）。</p>
    </details>
  </div>
</div>
