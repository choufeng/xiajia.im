...
export default defineConfig({
  ...
  head: [
    ...
    // 霞鹜文楷 Screen R（方案B迭代）· jsDelivr CDN · unicode-range 分包 · font-display:swap
    // R = Regular 屏幕优化微粗变体，阅读手感更沉
    ['link', { rel: 'stylesheet', href: 'https://cdn.jsdelivr.net/npm/lxgw-wenkai-screen-webfont/lxgwwenkaiscreenr.css' }],
  ],
      ...
      '/reading/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '《意志力》', link: '/reading/willpower' },
      ...
      '/cognition/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '前景理论', link: '/cognition/prospect-theory' },
      ...
      '/radio/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '系列 02（第 11-20 题）', link: '/radio/class-a-02' },
            { text: '系列 03（第 21-30 题）', link: '/radio/class-a-03' },
            { text: '系列 04（第 31-40 题）', link: '/radio/class-a-04' },
            { text: '系列 05（第 41-50 题）', link: '/radio/class-a-05' },
            { text: '系列 06（第 51-60 题）', link: '/radio/class-a-06' },
            { text: '系列 07（第 61-70 题）', link: '/radio/class-a-07' },
            { text: '系列 08（第 71-80 题）', link: '/radio/class-a-08' },
            { text: '系列 09（第 81-90 题）', link: '/radio/class-a-09' },
            { text: '系列 10（第 91-100 题）', link: '/radio/class-a-10' },
            { text: '系列 11（第 101-110 题）', link: '/radio/class-a-11' },
            { text: '系列 12（第 111-120 题）', link: '/radio/class-a-12' },
            { text: '系列 13（第 121-130 题）', link: '/radio/class-a-13' },
            { text: '系列 14（第 131-140 题）', link: '/radio/class-a-14' },
            { text: '系列 15（第 141-150 题）', link: '/radio/class-a-15' },
            { text: '系列 16（第 151-160 题）', link: '/radio/class-a-16' },
            { text: '系列 17（第 161-170 题）', link: '/radio/class-a-17' },
            { text: '系列 18（第 171-180 题）', link: '/radio/class-a-18' },
            { text: '系列 19（第 181-190 题）', link: '/radio/class-a-19' },
            { text: '系列 20（第 191-200 题）', link: '/radio/class-a-20' },
            { text: '系列 21（第 201-210 题）', link: '/radio/class-a-21' },
            { text: '系列 22（第 211-220 题）', link: '/radio/class-a-22' },
            { text: '系列 23（第 221-230 题）', link: '/radio/class-a-23' },
            { text: '系列 24（第 231-240 题）', link: '/radio/class-a-24' },
            { text: '系列 25（第 241-250 题）', link: '/radio/class-a-25' },
            { text: '系列 26（第 251-260 题）', link: '/radio/class-a-26' },
            { text: '系列 27（第 261-270 题）', link: '/radio/class-a-27' },
            { text: '系列 28（第 271-280 题）', link: '/radio/class-a-28' },
            { text: '系列 29（第 281-290 题）', link: '/radio/class-a-29' },
            { text: '系列 30（第 291-300 题）', link: '/radio/class-a-30' },
            { text: '系列 31（第 301-310 题）', link: '/radio/class-a-31' },
            { text: '系列 32（第 311-320 题）', link: '/radio/class-a-32' },
            { text: '系列 33（第 321-330 题）', link: '/radio/class-a-33' },
            { text: '系列 34（第 331-340 题）', link: '/radio/class-a-34' },
            { text: '系列 35（第 341-350 题）', link: '/radio/class-a-35' },
            { text: '系列 36（第 351-360 题）', link: '/radio/class-a-36' },
            { text: '系列 37（第 361-370 题）', link: '/radio/class-a-37' },
            { text: '系列 38（第 371-380 题）', link: '/radio/class-a-38' },
            { text: '系列 39（第 381-390 题）', link: '/radio/class-a-39' },
            { text: '系列 40（第 391-400 题）', link: '/radio/class-a-40' },
            { text: '系列 41（第 401-410 题）', link: '/radio/class-a-41' },
            { text: '系列 42（第 411-420 题）', link: '/radio/class-a-42' },
            { text: '系列 43（第 421-430 题）', link: '/radio/class-a-43' },
            { text: '系列 44（第 431-440 题）', link: '/radio/class-a-44' },
            { text: '系列 45（第 441-450 题）', link: '/radio/class-a-45' },
            { text: '系列 46（第 451-460 题）', link: '/radio/class-a-46' },
            { text: '系列 47（第 461-470 题）', link: '/radio/class-a-47' },
            { text: '系列 48（第 471-480 题）', link: '/radio/class-a-48' },
            { text: '系列 49（第 481-490 题）', link: '/radio/class-a-49' },
            { text: '系列 50（第 491-500 题）', link: '/radio/class-a-50' },
            { text: '系列 51（第 501-510 题）', link: '/radio/class-a-51' },
            { text: '系列 52（第 511-520 题）', link: '/radio/class-a-52' },
            { text: '系列 53（第 521-530 题）', link: '/radio/class-a-53' },
            { text: '系列 54（第 531-540 题）', link: '/radio/class-a-54' },
            { text: '系列 55（第 541-550 题）', link: '/radio/class-a-55' },
            { text: '系列 56（第 551-560 题）', link: '/radio/class-a-56' },
            { text: '系列 57（第 561-570 题）', link: '/radio/class-a-57' },
            { text: '系列 58（第 571-580 题）', link: '/radio/class-a-58' },
            { text: '系列 59（第 581-590 题）', link: '/radio/class-a-59' },
            { text: '系列 60（第 591-600 题）', link: '/radio/class-a-60' },
            { text: '系列 61（第 601-610 题）', link: '/radio/class-a-61' },
            { text: '系列 62（第 611-620 题）', link: '/radio/class-a-62' },
            { text: '系列 63（第 621-630 题）', link: '/radio/class-a-63' },
            { text: '系列 64（第 631-640 题）', link: '/radio/class-a-64' },
            { text: '系列 65（第 641-650 题）', link: '/radio/class-a-65' },
            { text: '系列 66（第 651-660 题）', link: '/radio/class-a-66' },
            { text: '系列 67（第 661-670 题）', link: '/radio/class-a-67' },
            { text: '系列 68（第 671-680 题）', link: '/radio/class-a-68' },
            { text: '系列 69（第 681-683 题）', link: '/radio/class-a-69' },
          ],
        },
      ],
      ...
      '/speaking/': [
        {
          ...
          items: [
            ...
            { text: 'Day 6 · 首尾怎么守', link: '/speaking/06-day6-first-and-last' },
            { text: 'Day 7 · 例子怎么讲出画面', link: '/speaking/07-day7-tell-a-story' },
            { text: 'Day 8 · 从独白到对话', link: '/speaking/08-day8-dialogue' },
            { text: 'Day 9 · 紧张来了怎么共处', link: '/speaking/09-day9-nerves' },
            { text: 'Day 10 · 九样东西拼成一段话', link: '/speaking/10-day10-putting-it-together' },
         ],
        },
      ],
